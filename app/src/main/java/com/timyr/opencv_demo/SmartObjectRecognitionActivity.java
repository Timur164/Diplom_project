...
public class SmartObjectRecognitionActivity extends Activity implements View.OnTouchListener, CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public SmartObjectRecognitionActivity(){
        super();
    }
    ...
    public void javaFindObject(String detectorName, String extractorName, String matcherName){
        ...
        try {
            ...
            for (int i = 0; i < good_matches.size(); i++) {
                ...
                Imgproc.circle(imageSceneRgba, new Point(sceneListGoodMatches.get(i).x, sceneListGoodMatches.get(i).y), 3, new Scalar( 255, 0, 0, 255));

            }
            String text = "Good Matches Count: " + good_matches.size();
            Imgproc.putText(imageSceneRgba, text, new Point(0,60), Core.FONT_HERSHEY_COMPLEX_SMALL, 1, new Scalar(0, 0, 255, 255));
            ...
            if(good_matches.size()>3){
                ...
                Imgproc.line(imageSceneRgba, new Point(scene_corners.get(0, 0)), new Point(scene_corners.get(1, 0)), new Scalar(0, 255, 0), 2);
                Imgproc.line(imageSceneRgba, new Point(scene_corners.get(1, 0)), new Point(scene_corners.get(2, 0)), new Scalar(0, 255, 0), 2);
                Imgproc.line(imageSceneRgba, new Point(scene_corners.get(2, 0)), new Point(scene_corners.get(3, 0)), new Scalar(0, 255, 0), 2);
                Imgproc.line(imageSceneRgba, new Point(scene_corners.get(3, 0)), new Point(scene_corners.get(0, 0)), new Scalar(0, 255, 0), 2);
